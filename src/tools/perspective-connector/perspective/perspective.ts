...
export type * from "@finos/perspective/dist/pkg/perspective-js.d.ts";
...
export async function compile_perspective() {
  let elem = customElements.get("perspective-viewer") as unknown as
    | WasmElement
    | undefined;
  if (!elem) {
    console.warn("No `<perspective-viewer>` Custom Element found, waiting");
    await customElements.whenDefined("perspective-viewer");
    elem = customElements.get("perspective-viewer") as unknown as WasmElement;
  }
